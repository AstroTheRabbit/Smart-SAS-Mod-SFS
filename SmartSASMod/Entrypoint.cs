...
namespace SmartSASMod
{
    ...
    public class Entrypoint : Mod, IUpdatable
    {
        ...
        public override string IconLink => "https://raw.githubusercontent.com/AstroTheRabbit/Smart-SAS-Mod-SFS/refs/heads/main/Images/Icon.png";
        ...
        public override void Load()
        {
            ...
            SceneHelper.OnWorldSceneLoaded += GUI.Init;
            try
            {
